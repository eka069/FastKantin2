...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    ...
    <div class="rounded-lg border overflow-hidden shadow-md mb-6">
        <div class="p-4 border-b bg-gray-50">
            ...
            <p class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($order->created_at)->format('d F Y, H:i') }} WIB</p>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="flex justify-between items-start mb-3">
                <div class="flex items-start gap-4">
                    <img src="https://via.placeholder.com/100" alt="Menu" class="w-20 h-20 rounded-md object-cover">
                    <div>
                        <h4 class="font-medium text-gray-800">
                            {{ $item->foodItem->name ?? 'Menu tidak ditemukan' }}
                        </h4>
                        <p class="text-sm text-gray-600">
                            Jumlah: {{ $item->quantity }} × Rp {{ number_format($item->price_per_item, 0, ',', '.') }}
                        </p>
